...
class LeaderboardDatabase:
    ...
    def __init__(self) -> None:
        self._cred_obj = cred_obj = firebase_admin.credentials.Certificate("pure-pulsars-firebase-adminsdk-e6qzr-9b1c9a771d.json")
    ...
    def _add_user_to_leaderboard(self, userID: int, leaderboardID : str) -> dict: # leave leaderboard id blank to go to global leaderboard
        self._ref = db.reference(f"/leaderboard/{leaderboardID}")
        ...
        self._leaderboard_dict[userID] = {"score" : 0, "place" : amount_of_users+1 }
